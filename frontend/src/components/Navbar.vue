  ...
  <header class="bg-white sticky top-0">
    <div class="mx-auto flex h-16 max-w-screen-xl items-center gap-6 px-4 py-10 sm:px-6 lg:px-8">
      <div class="flex items-center gap-4">
        ...
        <a
          class="text-xl font-semibold transition text-slight-black hover:text-slight-black/75"
          href="#"
          >asdasd</a
        >
      </div>
      ...
      <div class="flex flex-1 items-center justify-end">
        <div class="flex items-center gap-4">
          <div class="hidden sm:flex sm:gap-4">
            <router-link
              class="block rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-slight-black transition hover:text-slight-black/65"
              to="/profile"
            >
              Профиль
            </router-link>
